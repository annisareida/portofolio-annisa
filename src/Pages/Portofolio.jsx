...
const techStacks = [
  { icon: "python.webp", language: "Python" },
  { icon: "tensor.svg", language: "TensorFlow" },
  { icon: "pytorch.svg", language: "PyTorch" },
  { icon: "pandas.svg", language: "Pandas" },
  { icon: "numpy.svg", language: "Numpy" },
  { icon: "sql.svg", language: "SQL" },
  { icon: "power.png", language: "PowerBI" },
  { icon: "Streamlit.svg", language: "Streamlit" },
  { icon: "hugging.svg", language: "Hugging Face" },
  { icon: "reactjs.svg", language: "NodeJS" },
