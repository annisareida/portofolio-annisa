...
const WORDS = ["Informatics Engineering Graduate", "Data Enthusiast"];
const TECH_STACK = ["Python", "SQL", "PowerBI", "Tensorflow"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/annisareida", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/annisareida/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/annisa_reida", label: "Instagram Profile" }
];
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              ...
              "https://www.instagram.com/annisa_reida/"
            ]
          }
        `}</script>
      </Helmet>
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Developing accurate and innovative machine learning models and interactive dashboards to support data-driven decision making.
                  </p>
