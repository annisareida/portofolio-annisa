...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/annisareida",
      };
  ...
  const projectUrl = `https://annisareida.vercel.app/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Annisa Reida Raheima</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Annisa Reida Raheima — Data Scientist.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Annisa Reida Raheima`}
        />
        <meta
