...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/annisareida/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@annisa_reida",
    icon: Instagram,
    url: "https://www.instagram.com/annisa_reida/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@annisaheyy3328",
    icon: Youtube,
    url: "https://www.youtube.com/@annisaheyy3328",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@annisa_reida",
    icon: Github,
    url: "https://github.com/annisareida",
    color: "#ffffff",
